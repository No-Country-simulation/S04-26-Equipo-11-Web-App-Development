        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/incidentes/**")
                    .hasAnyRole("OPERADOR", "TECNICO", "SUPERVISOR")

                // Incidentes – POST (solo operador)
                .requestMatchers(HttpMethod.POST, "/api/incidentes")
                    .hasAnyRole("OPERADOR", "SUPERVISOR")

                // Incidentes – PUT (técnico y supervisor)
                .requestMatchers(HttpMethod.PUT, "/api/incidentes/**")
                    .hasAnyRole("TECNICO", "SUPERVISOR")

                // Incidentes – DELETE (solo supervisor)
